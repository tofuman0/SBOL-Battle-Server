			...
			if (!in.empty())
			{
				...
				try {
					...
					for (auto& member : in["members"])
					{
						...
						rival.carMods.colour1_R = TO_FLOAT_COLOUR(GET_R_COLOUR(colour1));
						rival.carMods.colour1_G = TO_FLOAT_COLOUR(GET_G_COLOUR(colour1));
						rival.carMods.colour1_B = TO_FLOAT_COLOUR(GET_B_COLOUR(colour1));
						rival.carMods.colour2_R = TO_FLOAT_COLOUR(GET_R_COLOUR(colour2));
						rival.carMods.colour2_G = TO_FLOAT_COLOUR(GET_G_COLOUR(colour2));
						rival.carMods.colour2_B = TO_FLOAT_COLOUR(GET_B_COLOUR(colour2));
						...
						rival.carMods.wheelcolour1_R = TO_FLOAT_COLOUR(GET_R_COLOUR(colour1));
						rival.carMods.wheelcolour1_G = TO_FLOAT_COLOUR(GET_G_COLOUR(colour1));
						rival.carMods.wheelcolour1_B = TO_FLOAT_COLOUR(GET_B_COLOUR(colour1));
						rival.carMods.wheelcolour2_R = TO_FLOAT_COLOUR(GET_R_COLOUR(colour2));
						rival.carMods.wheelcolour2_G = TO_FLOAT_COLOUR(GET_G_COLOUR(colour2));
						rival.carMods.wheelcolour2_B = TO_FLOAT_COLOUR(GET_B_COLOUR(colour2));
